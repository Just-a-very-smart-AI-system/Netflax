...
<head>
    ...
    <link rel="android-chrome-512x512" href="<?php echo e(asset('images/favicon_package/android-chrome-512x512.png')); ?>">
    <link rel="android-chrome-192x192" href="<?php echo e(asset('images/favicon_package/android-chrome-192x192.png')); ?>">
    <title>Netflax</title>
...
<header>
    <div class="container mb-3 my-4" style="top: 10px">
        <a href="#" target="_self">
            <img class="header__img" src="<?php echo e(asset('images/logo.png')); ?>" alt="logo">
        </a>
...
<footer class="text-gray-600 body-font" style="background-color: #000; margin-bottom: -5rem; margin-top: 1rem; background: linear-gradient(360deg, transparent, rgba(37, 37, 37, 0.61), #111 );">
    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src="<?php echo e(asset('images/favicon_package/favicon-32x32.png')); ?>" alt="Footer logo" width="30" height="24" 
...
<?php /**PATH C:\Users\Admin\Desktop\Web_Netflax\Web_Netflax\resources\views/home.blade.php ENDPATH**/ ?>